...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="missi-user 16 BP2A.250605.031.A3 OS3.0.8.0.WOJMIXM release-keys" \
    BuildFingerprint=POCO/rodin_global/rodin:16/BP2A.250605.031.A3/OS3.0.8.0.WOJMIXM:user/release-keys \
